...
const ArrayProjets = [
  ...
  { id: 2, nom: "Les Recettes d'Arnaud", image: "/assets/Photo Projet/travaux.png", description: "Site personnel dédié à la gestion et à la consultation de mes recettes de cuisine du quotidien, avec un frontend React/Tailwind et un backend Node.js/Express/MySQL.", lien: "https://github.com/Arnaud-Dvg/Les-Recettes" },
