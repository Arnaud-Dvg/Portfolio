...
const ArrayProjets = [
  ...
  { id: 2, nom: "Les Recettes d'Arnaud", image: "/assets/Photo Projet/travaux.png", description: "Site personnel dédié à la gestion et à la consultation de mes recettes de cuisine du quotidien, avec un frontend React/Tailwind et un backend Node.js/Express/MySQL.", lien: "https://github.com/Arnaud-Dvg/Les-Recettes-D--Arnaud" },
  { id: 3, nom: "Le Jardin Alsacien", image: "/assets/Photo Projet/Strasbouq.png", description: "Application de réservation de bouquets développée avec React et Tailwind, fonctionnant entièrement via LocalStorage. Elle permet de consulter le catalogue, filtrer les bouquets, gérer un panier, créer un compte, se connecter, et finaliser une réservation côté client.", lien: "https://github.com/Arnaud-Dvg/Le-Jardin-Alsacien", site: "https://le-jardin-alsacien-client.vercel.app/Catalogue" },
  { id: 4, nom: "Fourch'Est", image: "/assets/Photo Projet/Fourch.png", description: "Site front-end développé en JavaScript et Tailwind, permettant de commander des repas en ligne dans un restaurant traditionnel du Grand Est. L’application propose la consultation du menu, l’ajout de plats au panier et la finalisation d’une commande, avec une interface simple et responsive.", lien: "https://github.com/Arnaud-Dvg/FourchEst" },
  { id: 5, nom: "Kids-Quiz", image: "/assets/Photo Projet/Kids.png", description: "Mini-jeu éducatif développé en JavaScript et CSS, permettant aux enfants de répondre à une série de questions simples, avec un système de score et une interface ludique et colorée.", lien: "https://github.com/Arnaud-Dvg/KIDS-QUIZ", site: "https://kids-quiz-lyart.vercel.app/" },
  {
    id: 6, nom: "CarambarJoke", image: "/assets/Photo Projet/Joke.png", description: "Petite application web affichant une blague Carambar aléatoire grâce à une API que j’ai développée en Node.js / Express, avec une base SQLite gérée via Sequelize. L’API est documentée avec Swagger et déployée sur Render, tandis que le frontend en HTML/ CSS / JS est hébergé sur GitHub Pages.", lien: "https://github.com/Arnaud-Dvg/carambar-joke-client", site: "https://arnaud-dvg.github.io/carambar-joke-client/"
  }
];
